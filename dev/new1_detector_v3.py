...
# Pipeline optimisé et compatible
# On force exactement le mode 1920x1080 que ton log a détecté
pipeline = (
...
if not cap.isOpened():
    print("ERREUR CRITIQUE : Impossible d'ouvrir la caméra avec le pipeline GStreamer.")
    exit()
else:
    print("Succès : Caméra ouverte et flux capturé !")
